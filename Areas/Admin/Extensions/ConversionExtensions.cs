    ...
    public static class ConversionExtensions
    {
         ...
         this SubscriptionProduct subscriptionProducts, ApplicationDbContext db, bool addListData = true)
        {
            var model = new SubscriptionProductModel
            {
                ...
                i => i.Id.Equals(subscriptionProducts.SubscriptionId))).Title,
                ProductTitle = (await db.Products.FirstOrDefaultAsync(
                p => p.Id.Equals(subscriptionProducts.ProductId))).Title
        ...
        public static async Task<bool> CanChange(
            this SubscriptionProduct subscriptionProducts, ApplicationDbContext db)
        {
