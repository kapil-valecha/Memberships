...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Discription,Url,ImageUrl,HTML,WaitDays,ProductId,ItemTypeId,SectiontId,PartId,IsFree")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Discription,Url,ImageUrl,HTML,WaitDays,ProductId,ItemTypeId,SectiontId,PartId,IsFree")] Item item)
        {
            if (ModelState.IsValid)
            {
